...
class monster {
 public:
  monster(monster_enum monster_type,
          terrain_enum terrain_type,
          weapon_enum weapon_type)
...
int main() {
  monster monster_in_forest =
      monster(monster_enum::mosnter_a_type, terrain_enum::forest_terrain_type,
              gun_type);

  monster monster_with_arrow =
      monster(monster_enum::monster_b_type, terrain_enum::cyber_terrian_type,
              arrow_type);
  cout << "첫 번째 몬스터는 ";
